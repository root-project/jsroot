...
JSROOT.require("io").then(io => {
   io.addUserStreamer("amore::core::String_t", "TString");
});
...
JSROOT.require("painter").then(pp => {
   pp.addDrawFunc({ name: "amore::core::MonitorObjectHisto<TH1F>", icon: "img_histo1d", draw_field: "fVal" });
});
