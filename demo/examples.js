examples_main = {
   TH1 : [
     ...
     { name: "B", item: "hpx;1", opt:"B,fill_red", title: "draw histogram as bar chart" },
     { opt: "A", item: "hpx;1", title: "disables axes drawing" },
     { opt: "E" },
     ...
     { name: "text", item: "hpx;1", opt: "hist,text" },
   ...
   TH2 : [
     ...
     { opt: "alego2", title: "3D lego plot without axis drawings - option A" },
