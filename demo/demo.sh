...
mkdir -p Canvases/c1; wget -nv $server/Canvases/c1/root.json.gz?compact=3 -O Canvases/c1/root.json.gz
mkdir -p Files
...
mkdir -p Files/job1.root/hpx; wget -nv $server/Files/job1.root/hpx/root.json.gz?compact=3 -O Files/job1.root/hpx/root.json.gz
mkdir -p Files/job1.root/hpxpy; wget -nv $server/Files/job1.root/hpxpy/root.json.gz?compact=3 -O Files/job1.root/hpxpy/root.json.gz
mkdir -p Files/job1.root/hprof; wget -nv $server/Files/job1.root/hprof/root.json.gz?compact=3 -O Files/job1.root/hprof/root.json.gz
