...
let obj = await jsroot.httpRequest('https://root.cern/js/files/geom/simple_alice.json.gz', 'object');

let svg = await jsroot.makeSVG({ object: obj, width: 1200, height: 800 /*, option: "r3d_svg" */ });
