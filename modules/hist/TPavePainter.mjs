...
import { floatToString, makeTranslateG, compressSVG, svgToImage, addHighlightStyle } from '../base/BasePainter.mjs';
...
class TPavePainter extends ObjectPainter {
   ...
   async drawPave(arg) {
      ...
      return promise.then(() => {
         ...
         makeTranslateG(this.draw_g, this._pave_x, this._pave_y);
         ...
         if (pt._typename == clTDiamond) {
            ...
            makeTranslateG(text_g, Math.round(width/4), Math.round(height/4));
