...
.jsroot .img_list {
    ...
    height: 16px;
    width: 16px;
    background-image: url("data:image/png;base64,");
}
.jsroot .img_color {
    display: inline-block;
    height: 16px;
    width: 16px;
    background-image: url("data:image/png;base64,");
}
.jsroot .img_colz {
    display: inline-block;
    height: 16px;
    width: 16px;
    background-image: url("data:image/png;base64,");
}
.jsroot .img_frame {
    display: inline-block;
    height: 16px;
    width: 16px;
    background-image: url("data:image/png;base64,");
}
.jsroot .img_class {
    display: inline-block;
    height: 16px;
    width: 16px;
    background-image: url("data:image/png;base64,");
}
...
.jsroot .img_member {
    ...
    height: 16px;
    width: 16px;
    background-image: url("data:image/png;base64,");
}
.jsroot .img_tf1 {
    display: inline-block;
    height: 16px;
