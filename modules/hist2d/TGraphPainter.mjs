import { gStyle, BIT, settings, create, createHistogram, setHistogramTitle, isFunc, isStr,
         clTPaveStats, clTCutG, clTH1F, clTH2D, clTF1, clTF2, clTPad, kNoZoom, kNoStats } from '../core.mjs';
...
class TGraphPainter extends ObjectPainter {
   ...
   createHistogram(set_x = true, set_y = true) {
      ...
      if (!histo) {
         histo = this._is_scatter ? createHistogram(clTH2D, 30, 30) : createHistogram(clTH1F, 100);
