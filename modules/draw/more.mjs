...
class TEfficiencyPainter extends ObjectPainter {
   ...
   static async draw(dom, eff, opt) {
      ...
      painter.fBoundary = jsroot_math.getTEfficiencyBoundaryFunc(eff.fStatisticOption, eff.TestBit(kIsBayesian));
...
export { TF1Painter, TGraphPainter, TGraphPolargramPainter, TGraphPolarPainter, TMultiGraphPainter,
         TSplinePainter, TASImagePainter, TRatioPlotPainter, TEfficiencyPainter, TWebPaintingPainter,
