...
import { gStyle, BIT, settings, create, isBatchMode, isNodeJs } from '../core.mjs';
...
export { TF1Painter, TGraphPolargramPainter, TGraphPolarPainter, TMultiGraphPainter,
         TSplinePainter, TASImagePainter, TRatioPlotPainter, TWebPaintingPainter,
         drawText, drawLine, drawPolyLine, drawEllipse, drawPie, drawBox,
         drawMarker, drawPolyMarker, drawArrow, drawJSImage, proivdeEvalPar };
