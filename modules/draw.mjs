...
const drawFuncs = { lst: [
   ...
   { name: clTF2, icon: 'img_tf2', class: () => import('./draw/TF2.mjs').then(h => h.TF2Painter), opt: ';BOX;ARR;SURF;SURF1;SURF2;SURF4;SURF6;LEGO;LEGO0;LEGO1;LEGO2;LEGO3;LEGO4;same' },
