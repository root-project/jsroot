...
let drawFuncs = { lst: [
   ...
   { name: "TPave", icon: "img_pavetext", class: () => import('./hist.mjs').then(h => h.TPavePainter) },
   ...
   { name: /^TH2/, icon: "img_histo2d", class: () => import('./hist.mjs').then(h => h.TH2Painter), dflt: "col", opt: ";COL;COLZ;COL0;COL1;COL0Z;COL1Z;COLA;BOX;BOX1;PROJ;PROJX1;PROJX2;PROJX3;PROJY1;PROJY2;PROJY3;SCAT;TEXT;TEXTE;TEXTE0;CANDLE;CANDLE1;CANDLE2;CANDLE3;CANDLE4;CANDLE5;CANDLE6;CANDLEY1;CANDLEY2;CANDLEY3;CANDLEY4;CANDLEY5;CANDLEY6;VIOLIN;VIOLIN1;VIOLIN2;VIOLINY1;VIOLINY2;CONT;CONT1;CONT2;CONT3;CONT4;ARR;SURF;SURF1;SURF2;SURF4;SURF6;E;A;LEGO;LEGO0;LEGO1;LEGO2;LEGO3;LEGO4;same", ctrl: "lego" },
   { name: "TProfile2D", sameas: "TH2" },
   { name: /^TH3/, icon: 'img_histo3d', class: () => import('./hist3d.mjs').then(h => h.TH3Painter), opt: ";SCAT;BOX;BOX2;BOX3;GLBOX1;GLBOX2;GLCOL" },
   { name: "THStack", icon: "img_histo1d", class: () => import('./hist.mjs').then(h => h.THStackPainter), expand_item: "fHists", opt: "NOSTACK;HIST;E;PFC;PLC" },
   ...
   { name: "TGraph2D", icon: "img_graph", class: () => import('./hist3d.mjs').then(h => h.TGraph2DPainter), opt: ";P;PCOL", theonly: true },
   { name: "TGraph2DErrors", icon: "img_graph", class: () => import('./hist3d.mjs').then(h => h.TGraph2DPainter), opt: ";P;PCOL;ERR", theonly: true },
   ...
   { name: "TLegend", icon: "img_pavelabel", class: () => import('./hist.mjs').then(h => h.TPavePainter) },
