...
const drawFuncs = { lst: [
   ...
   { name: "TGeoVolume", icon: 'img_histo3d', class: () => import('./geom/geom.mjs').then(h => h.TGeoPainter), get_expand: () => import('./geom/geom.mjs').then(h => h.expandGeoObject), opt: ";more;all;count;projx;projz;wire;no_screen;dflt", ctrl: "dflt" },
