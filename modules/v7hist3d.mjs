...
RHistPainter.prototype.drawLego = function() {
   ...
   let material = new LineBasicMaterial({ color: new Color(lcolor), linewidth: this.v7EvalAttr("line_width", 1) });
...
RH2Painter.prototype.draw3DBins = function() {
...
RH2Painter.prototype.drawContour3D = function(realz) {
...
/** @summary Draw RH2 histograms in surf mode
  * @private */
RH2Painter.prototype.drawSurf = function() {
...
RH2Painter.prototype.drawError = function() {
   let main = this.getFramePainter(),
       histo = this.getHisto(),
       handle = this.prepareDraw({ rounding: false, use3d: true, extra: 1 }),
...
RH2Painter.prototype.drawPolyLego = function() {
   let histo = this.getHisto(),
       palette = this.getHistPalette(),
