...
26. Fix - correct scaling of axis labels when tilt them by 25 degree, make this angle configurable
27. Fix - legend multi-columns drawing and labels scaling
28. Fix - graph "B" bar widths as in native ROOT
29. Fix - use pad and not frame size for TText/TLatex scaling
