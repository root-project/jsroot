...
JSROOT.define(['d3', 'painter'], (d3, jsrp) => {
   ...
   function objectHierarchy(top, obj, args) {
      ...
      let isarray = (proto.length >= 14) &&  (proto.lastIndexOf('Array]') == proto.length-6) && (proto.indexOf('[object ')==0) && obj.length,
      ...
      for (let key in obj) {
         ...
         if (typeof fld == 'object') {
            ...
            if ((proto.length >= 14) && (proto.lastIndexOf('Array]') == proto.length-6) && (proto.indexOf('[object ')==0)) {
