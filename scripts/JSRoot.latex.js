...
JSROOT.define(['d3', 'painter'], (d3, jsrp) => {
   ...
   const symbolsMap = {
      ...
      'i': '\u03B9', 'k': '\u03BA', 'l': '\u03BB', 'm': '\u03BC', 'n': '\u03BD', 'x': '\u03BE', 'o': '\u03BF', 'p': '\u03C0',
      'r': '\u03C1', 's': '\u03C3', 't': '\u03C4', 'u': '\u03C5', 'f': '\u03C6', 'c': '\u03C7', 'y': '\u03C8', 'w': '\u03C9',
      'V': '\u03C2', 'J': '\u03D1', 'j': '\u03D5', 'v': '\u03D6', 161: 978,
      162: 8242, 164: 8260, 178: 8243, 188: 8230,
      192: 8501, 193: 8465, 194: 8476, 195: 8472, 212: 8482, 228: 8482,
      240: 8364,
      171: 8596, 172: 8592, 173: 8593, 174: 8594, 175: 8595, 191: 8629, 219: 8660, 220: 8656, 221: 8657, 222: 8658, 223: 8659,
      34: 8704, 36: 8707, 39: 8717, 42: 8727, 45: 8722, 64: 8773, 92: 8756, 94: 8869, 126: 8764, 163: 8804,
      165: 8734, 179: 8805, 181: 8733, 182: 8706, 183: 8729, 185: 8800, 186: 8801, 187: 8776, 196: 8855, 197: 8853, 198: 8709,
      199: 8745, 200: 8746, 201: 8835, 202: 8839, 203: 8836, 204: 8834, 205: 8838, 206: 8712, 207: 8713, 208: 8736, 209: 8711,
      213: 8719, 214: 8730, 215: 8901, 217: 8743, 218: 8744, 229: 8721, 242: 8747,
      225: 9001, 241: 9002, 243: 8992, 245: 8993,
      224: 9674,
      167: 9827, 168: 9830, 169: 9829, 170: 9824
   };

   ltx.replaceSymbols = function(s) {
      if (!symbolsMap.parsed) {
         let keys = Object.keys(symbolsMap);
         for (let i = 0; i < keys.length; ++i) {
            if (keys[i].length > 1) {
               let old_symbol = String.fromCharCode(parseInt(keys[i])),
                   new_symbol = String.fromCharCode(symbolsMap[keys[i]]);
               delete symbolsMap[keys[i]];
               symbolsMap[old_symbol] = new_symbol;
             }
         }
         symbolsMap.parsed = true;
      }
