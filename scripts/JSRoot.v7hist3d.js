...
JSROOT.define(['d3', 'base3d', 'painter', 'v7hist'], (d3, THREE, jsrp) => {
   ...
   JSROOT.v7.RFramePainter.prototype.DrawXYZ = function(toplevel, opts) {
      ...
      this.x_handle = new JSROOT.v7.RAxisPainter(this.divid, this, this.xaxis, "x_");
      ...
      this.y_handle = new JSROOT.v7.RAxisPainter(this.divid, this, this.yaxis, "y_");
      ...
      this.z_handle = new JSROOT.v7.RAxisPainter(this.divid, this, this.zaxis, "z_");
