...
(function( factory ) {
   ...
   JSROOT.addDrawFunc({ name: "THStack", icon: "img_histo1d", prereq: "v6;hist", func: "JSROOT.Painter.drawHStack", expand_item: "fHists", opt: "PFC;PLC" });
   ...
   JSROOT.addDrawFunc({ name: "TGaxis", icon: "img_graph", prereq: "v6;hist", func: "JSROOT.Painter.drawGaxis" });
