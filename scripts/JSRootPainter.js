...
JSROOT.require(['d3'], (d3) => {
   ...
   */
   ...
   JSROOT.DrawFuncs = { lst:[
      ...
      { name: "TTree", icon: "img_tree", prereq: "tree;more2d", expand: '.TreeHierarchy', func: '.drawTree', dflt: "expand", opt: "player;testio", shift: "inspect" },
      { name: "TNtuple", icon: "img_tree", prereq: "tree;more2d", expand: '.TreeHierarchy', func: '.drawTree', dflt: "expand", opt: "player;testio", shift: "inspect" },
      { name: "TNtupleD", icon: "img_tree", prereq: "tree;more2d", expand: '.TreeHierarchy', func: '.drawTree', dflt: "expand", opt: "player;testio", shift: "inspect" },
      { name: "TBranchFunc", icon: "img_leaf_method", prereq: "tree;more2d", func: '.drawTree', opt: ";dump", noinspect: true },
      { name: /^TBranch/, icon: "img_branch", prereq: "tree;more2d", func: '.drawTree', dflt: "expand", opt: ";dump", ctrl: "dump", shift: "inspect", ignore_online: true },
      { name: /^TLeaf/, icon: "img_leaf", prereq: "tree;more2d", noexpand: true, func: '.drawTree', opt: ";dump", ctrl: "dump", ignore_online: true },
