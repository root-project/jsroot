...
JSROOT.require(['d3', 'JSRootPainter'], function(d3) {
   ...
   class TAxisPainter extends JSROOT.ObjectPainter {
    ...
    /** Create TAxis Painter
      ...
      * @param {boolean} embedded - if true, painter used in other objects painters */
      ...
      SetAxisConfig(name, kind, func, min, max, smin, smax) {
         this.name = name;
         this.kind = kind;
         this.func = func;
   ...
   //                 .style("pointer-events","none"); // let forward double click to underlying elements
      ...
      DrawAxis(vertical, layer, w, h, transform, reverse, second_shift, disable_axis_drawing, max_text_width) {
   ...
   class TFramePainter extends JSROOT.ObjectPainter {
      ...
      constructor(tframe) {
         super((tframe && tframe.$dummy) ? null : tframe);
         this.zoom_kind = 0;
         this.mode3d = false;
      ...
      GetTipName(append) {
         let res = super.GetTipName() || "TFrame";
         if (append) res+=append;
         return res;
      }

      Shrink(shrink_left, shrink_right) {
      ...
      DrawAxes(shrink_forbidden, disable_axis_draw, AxisPos, has_x_obstacle) {
      ...
      IsAxisZoomed(axis) { return this['zoom_'+axis+'min'] !== this['zoom_'+axis+'max']; }
      ...
      AnalyzeMouseWheelEvent(event, item, dmin, ignore) {
   ...
   class TPadPainter extends JSROOT.ObjectPainter {
      ...
      SelectObjectPainter (_painter, pos) {
      ...
      InteractiveObjectRedraw (_painter) {
      ...
      FindPrimitive (exact_obj, classname, name) {
      ...
      DrawPrimitives (indx, callback, ppainter) {
      ...
      DrawNextSnap (lst, indx, call_back, objpainter) {
      ...
      ProduceImage (full_canvas, file_format, call_back) {
   ...
   //      document.body.style.cursor = 'wait';
      ...
      toggleButtonsVisibility (action) {
      ...
      AddButton (_btn, _tooltip, _funcname, _keyname) {
   ...
   class TCanvasPainter extends TPadPainter {
      ...
      ChangeLayout (layout_kind, call_back) {
      ...
      ToggleProjection (kind, call_back) {
      ...
      DrawInSidePanel (canv, opt, call_back) {
      ...
      SubmitMenuRequest (painter, kind, reqid, call_back) {
      ...
      ActivateGed (objpainter, kind, mode, callback) {
